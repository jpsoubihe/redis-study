...
class FoodServiceTest {
    ...
    @Test
    public void shouldSuccessfullyGetFood() throws AttributeNotFoundException {
        when(foodRedisTemplate.opsForValue()).thenReturn(valueOperations);
    ...
    public void shouldThrowExceptionIfElementNotFoundWhenGetFood() {
        ...
        Assertions.assertThrows(AttributeNotFoundException.class, () -> foodService.getFood(foodId));
    }
